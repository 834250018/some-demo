package cn.ve.designpattern.structural_patterns.AdapterPattern.demo2;
...
public class Main {
    public static void main(String[] args) {
        ...
        new AbstractUserAdaptor() {
            @Override
            void newRegistry(String username, String password, String address, Integer age, Integer sex) {
