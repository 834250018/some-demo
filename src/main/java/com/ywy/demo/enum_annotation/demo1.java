...
public class demo1 {
    ...
    public static void main(String[] args) {
        ...
        Plant[] plants = {
                new Plant("ANNUAL", Plant.LifeCycle.ANNUAL),
                new Plant("BIENNIAL", Plant.LifeCycle.BIENNIAL)};

        System.out.println(Arrays.stream(plants)
        ...
        // 一般通过这种方式判断注解是否存在
        System.out.println(demo1.class.isAnnotationPresent(TestException.class) || demo1.class.isAnnotationPresent(TestExceptionContainer.class)); // true
    }
}
